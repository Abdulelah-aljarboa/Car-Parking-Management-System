...
#include <NewPing.h>
 ...
 const char* SSID ="WIFI_NAME"; //the HotSpot that is going to be connected to
 const char* password="WIFI_PASSWORD"; //the password for it
 const uint16_t port = 28002; //the port specified by the server
 const char* host = "SERVER_IP_ADDRESS"; //server IP address
